    ...
    waitForElement('body > form > div:nth-child(3) > table > tbody > tr:nth-child(19) > td:nth-child(4)', function(targetElement) {
        targetElement.innerHTML += `
            <select id="auto-time-selector" style="vertical-align: middle; width:50px;">
                <option value=""></option>
                ${['18:00', '18:30', '19:00', '19:30', '20:00', '20:30', '21:00', '21:30', '22:00', '22:30', '23:00', '23:30'].map(time => `<option value="${time}">${time}</option>`).join('')}
            </select>
            <input type="text" maxlength="30" id="auto-text" style="width:130px;">
            <div id="selected-time" style="font-weight: bold;color: red; font-size: larger;"></div><div id="selected-value" style="margin-left: 35px;font-weight: bold;color: red; font-size: larger;padding-left: 1rem;"></div>
        `;
